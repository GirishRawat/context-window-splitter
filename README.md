...
**MSc Research Project** — Optimising LLVM Intermediate Representation (IR) by routing IR functions through Large Language Models as optimisation engines, with **formal verification (Alive2/Z3) guaranteeing correctness** of every accepted transformation.
